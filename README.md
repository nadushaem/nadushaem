...
Pet-проект для поиска работы: бот, который мониторит job-борды и присылает в Telegram подборку вакансий data scientist / ml engineer. Каждый подписчик настраивает
